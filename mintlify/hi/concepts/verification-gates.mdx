...
<Note>
  `--deep` एक multi-lens consensus तक escalate करता है: बदलाव को कई स्वतंत्र
...
<Note>
  `forge precommit` एक commit-level gate है — यह commit time पर verification
...
[क्रॉस-सेशन मेमोरी](/hi/concepts/cross-session-memory)) अब एजेंट के handoff को इस बात के
...
- मौजूदा बदलावों के विरुद्ध रिकॉर्ड किया गया एक ताज़ा passing `forge verify`।
