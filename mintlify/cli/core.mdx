...
forge docs render    # regenerate machine-owned tables, counts, diagrams, and the changelog page
...
<Note>
  ...
  theme, and the repo map from the code registries, and this site's changelog page from
  `CHANGELOG.md`. `docs sync` sweeps the diff and
