...
tools` fixes that without changing what `sync` emits (`--reset` clears the primary tool and
leaves the recorded `tools` set alone).
...
| `forge sync`                     | Recompile `source/` → each selected tool's files (idempotent); rewrites only forge's block in `AGENTS.md`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
