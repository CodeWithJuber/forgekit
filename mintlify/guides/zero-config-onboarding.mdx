---
title: "Guided, low-configuration onboarding"
description: "Five minutes to productive: install once, configure a repo once, do a task, and watch the ledger start paying off on day two — guided, low-configuration, not zero-touch."
---
...
OpenClaw all read the **same** rules — each from its own native file. Change a rule later by editing
